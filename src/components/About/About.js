      ...
      <div className="Container">
        ...
        <ScrollAnimation animateIn="fadeInLeft">
          ...
          <div className="AboutBio">
            <ScrollAnimation animateIn="fadeInLeft">
            Hello! My name is <strong>Talha Kenan</strong>. I'm from Turkey and have been living in Sakarya for the past four years. During my time here, I gained valuable experience through various entry-level positions, which greatly enhanced my work ethic, communication skills, and adaptability.
            </ScrollAnimation>
